      ...
      <div class="sm:flex flex-auto">
        <div class="items-center hidden mb-3 sm:flex sm:mb-0">
          ...
          {#if selectedItems.length > 0}
            ...
            <span class="text-sm text-zinc-400 ml-4"
              >{selectedItems.length} Seleccionados</span
            >
          {/if}
        </div>
                        ...
                        >
                          ...
                          {:else if key.type === "image"}
                            <div class="flex gap-2">
                              <img
                                class="bg-[#fff] rounded-lg w-[70px]"
                                alt="Imágen"
                                src={document[key.name]}
                              />
                            </div>
                          ...
                          {:else}
                            ...
                            {#if document[key.name] === null}
                              <span class="line-clamp-2">No content</span>
    ...
    >
      <div class="flex items-center mb-4 sm:mb-0">
        ...
        <span class="text-sm font-normal text-zinc-500 dark:text-zinc-400"
          >Showing <span class="font-semibold text-zinc-900 dark:text-white"
            >1 - {limit}</span
          >
          of
